        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdmissionModel>(entity =>
            {
                entity.HasKey(e => e.AdmissionId)
                    .HasName("PK__Admissio__705A82594AB9BAF6");
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .HasConstraintName("FK__Admission__cours__71D1E811");

                entity.HasOne(d => d.Institute)
                    .WithMany(p => p.AdmissionModels)
                    .HasForeignKey(d => d.InstituteId)
                    .HasConstraintName("FK__Admission__insti__72C60C4A");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.AdmissionModels)
                    .HasForeignKey(d => d.StudentId)
                    .HasConstraintName("FK__Admission__stude__70DDC3D8");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.AdmissionModels)
                    .HasForeignKey(d => d.Userid)
                    .HasConstraintName("FK__Admission__useri__73BA3083");
            });
